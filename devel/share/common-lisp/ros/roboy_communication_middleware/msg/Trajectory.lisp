...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_communication_middleware-msg:<Trajectory> is deprecated: use roboy_communication_middleware-msg:Trajectory instead.")))
...
(cl:defmethod samplerate-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_communication_middleware-msg:samplerate-val is deprecated.  Use roboy_communication_middleware-msg:samplerate instead.")
  (samplerate m))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_communication_middleware-msg:waypoints-val is deprecated.  Use roboy_communication_middleware-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Trajectory>)))
  ...
  (cl:format cl:nil "uint32 id~%float32 samplerate~%float32[] waypoints~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Trajectory)))
  "Returns full string definition for message of type 'Trajectory"
  (cl:format cl:nil "uint32 id~%float32 samplerate~%float32[] waypoints~%~%~%~%"))
