...
;//! \htmlinclude ErrorNotification.msg.html

(cl:defclass <ErrorNotification> (roslisp-msg-protocol:ros-message)
  ((code
    :reader code
    :initarg :code
    :type cl:integer
...
(cl:defclass ErrorNotification (<ErrorNotification>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ErrorNotification>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ErrorNotification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_communication_control-msg:<ErrorNotification> is deprecated: use roboy_communication_control-msg:ErrorNotification instead.")))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <ErrorNotification>))
...
(cl:defmethod object-val ((m <ErrorNotification>))
...
(cl:defmethod msg-val ((m <ErrorNotification>))
...
(cl:defmethod extra-val ((m <ErrorNotification>))
...
(cl:defmethod validityDuration-val ((m <ErrorNotification>))
  ...
  (validityDuration m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ErrorNotification>) ostream)
  "Serializes a message object of type '<ErrorNotification>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ErrorNotification>) istream)
  "Deserializes a message object of type '<ErrorNotification>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ErrorNotification>)))
  "Returns string type for a message object of type '<ErrorNotification>"
  "roboy_communication_control/ErrorNotification")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ErrorNotification)))
  "Returns string type for a message object of type 'ErrorNotification"
  "roboy_communication_control/ErrorNotification")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ErrorNotification>)))
  "Returns md5sum for a message object of type '<ErrorNotification>"
  "e83a19f2165c907848c09efd00ad9d5e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ErrorNotification)))
  "Returns md5sum for a message object of type 'ErrorNotification"
  "e83a19f2165c907848c09efd00ad9d5e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ErrorNotification>)))
  "Returns full string definition for message of type '<ErrorNotification>"
  (cl:format cl:nil "int32 code~%string object~%string msg~%string extra~%int32 validityDuration~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ErrorNotification)))
  "Returns full string definition for message of type 'ErrorNotification"
  (cl:format cl:nil "int32 code~%string object~%string msg~%string extra~%int32 validityDuration~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ErrorNotification>))
  (cl:+ 0
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ErrorNotification>))
  "Converts a ROS message object to a list"
  (cl:list 'ErrorNotification
