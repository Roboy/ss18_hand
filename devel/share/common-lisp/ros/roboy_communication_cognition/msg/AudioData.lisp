...
(cl:defmethod cl:initialize-instance :after ((m <AudioData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AudioData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_communication_cognition-msg:<AudioData> is deprecated: use roboy_communication_cognition-msg:AudioData instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <AudioData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_communication_cognition-msg:data-val is deprecated.  Use roboy_communication_cognition-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AudioData>)))
  ...
  "roboy_communication_cognition/AudioData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AudioData)))
  "Returns string type for a message object of type 'AudioData"
  "roboy_communication_cognition/AudioData")
