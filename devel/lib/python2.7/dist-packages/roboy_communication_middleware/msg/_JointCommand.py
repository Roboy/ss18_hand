...
"""autogenerated by genpy from roboy_communication_middleware/JointCommand.msg. Do not edit."""
import sys
...
class JointCommand(genpy.Message):
  _md5sum = "b1291289f62fecbebd3e6705db37ed4e"
  _type = "roboy_communication_middleware/JointCommand"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string[] link_name
float32[] angle"""
  __slots__ = ['link_name','angle']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.link_name)
      buff.write(_struct_I.pack(length))
      for val1 in self.link_name:
        length = len(val1)
